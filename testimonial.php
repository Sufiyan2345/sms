...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-dark navbar-light sticky-top py-lg-0 px-lg-5 wow fadeIn" data-wow-delay="0.1s">
        <a href="home.html" class="navbar-brand ms-4 ms-lg-0 ">
            ...
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu m-0">
                        <a href="cart.php" class="dropdown-item">Hair Cut</a>
                        <a href="cart2.php" class="dropdown-item">Bread Trim</a>
                        <a href="cart3.php" class="dropdown-item">Men Shaves</a>
                        <a href="cart4.php" class="dropdown-item">Hair Dyeing
                        </a>
                        <a href="cart4.php" class="dropdown-item">Mustache</a>
                    </div>
                </div>
