        ...
        <div class="main-panel">
            <div class="content-wrapper">
                ...
                <div class="container-fluid text-left">
                    <h1>Service Data</h1>
                    <a href="add_service.php" class="btn btn-primary"><span class="mdi mdi-plus"></span> Add New Service</a>
                </div>
...
<td class="text-center">
    <!-- Pass the service ID to the edit_service.php page -->
    <a href="edit_service.php?id=<?php echo $row['id']; ?>" class="btn btn-primary">
        <i class="mdi mdi-pencil"></i> Edit
    </a>
</td>
<td class="text-center">
    <!-- Pass the service ID to the delete_service.php page and confirm deletion -->
    <a href="delete_service.php?id=<?php echo $row['id']; ?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this service?');">
